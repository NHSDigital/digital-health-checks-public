...
![Integration overview](/digital-health-checks-public/dev-guide/assets/Integration-overview.png)
...
The process is asynchronous and is divided into two main parts: [payload processing](../dev-guide/health-check-data-flow/) and the [acknowledgement flow](../dev-guide/acknowledgement-flow/), each described on their respective pages.
